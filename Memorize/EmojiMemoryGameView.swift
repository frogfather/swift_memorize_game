                ...
                ZStack {
                    Group {
                        if card.isConsumingBonusTime {
                            ...
                            //Animations can generally only animate things that have already happened
                            //Here we want to animate the bonus time going to 0 which hasn't yet happened
                            Pie(startAngle: Angle(degrees: -90), endAngle: Angle(degrees: (1 - animatedBonusRemaining)*360-90))
                                .onAppear {
                                    //Set our @State variable animatedBonusRemaining to the card's current value
                                    animatedBonusRemaining = card.bonusRemaining
                                    //animate with a duration = the remaining bonus time
                                    withAnimation(.linear(duration: card.bonusTimeRemaining)) {
                                        //and animate that @State variable going to zero
